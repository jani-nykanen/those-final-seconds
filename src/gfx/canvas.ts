...
/*
    ...
    public drawBitmap(_bmp : Bitmap | string, flip : Flip = Flip.None,
        ...
        const bmp : Bitmap = typeof(_bmp) == "string" ? this.getBitmap?.(_bmp) : _bmp;
        if (bmp === undefined) {
    ...
    public drawText(_font : Bitmap | string, text : string, 
        ...
        const font : Bitmap = typeof(_font) == "string" ? this.getBitmap?.(_font) : _font;
        if (font === undefined) {
